    ...
    <div className="app-wrapper">
      <Router basename="/organizer">
        <header className="app-header bg-primary text-white text-center d-flex align-items-center justify-content-center">
          ...
          <NavUser
           role={userRole} className="nav-user" />} {/* NavUser nur für Rolle 'user' */}
        </header>
          ...
          <Routes>
            ...
            {isLoggedIn ? (
              <>
                ...
                <Route path="/profiledit" element={<Profiledit />} /> {/* ProfilEdit-Route */}
              </>
            ) : (
        ...
        <footer className="app-footer bg-dark text-white">
         ...
         <p className="mb-0 small font-monospace text-center">© 2025 A.Schurer. Alle Rechte vorbehalten.</p>
        <p className="mb-0 small font-monospace text-end">Version 0.0.1-alpha.1</p>
        </footer>
      </Router>
    </div>
  );
