...
function Login({ onLogin }) {
  ...
  useEffect(() => {
    const storedRole = localStorage.getItem('role'); // Prüfe localStorage
    if (storedRole) {
      onLogin(storedRole);
      ...
      switch (storedRole) {
        ...
        case 'user':
          ...
          break;
        default:
          console.error('Unbekannte gespeicherte Rolle:', storedRole);
          localStorage.removeItem('role'); // Ungültige Rolle entfernen
      }
    }
  }, [onLogin, navigate]);
            ...
            if (userRole) {
              ...
              switch (userRole) {
                ...
                case 'user':
                  ...
                  break;
                default:
                  console.error('Unbekannte Rolle');
              }
            } else {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (userDocSnap.exists()) {
        ...
        // Rolle in localStorage speichern
